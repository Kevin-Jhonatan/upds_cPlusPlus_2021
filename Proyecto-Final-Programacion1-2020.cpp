// Proyecto-Final-Programacion1.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
#include <iostream>
#include <string>
#include <cstdlib>
...
int main()
{
	...
	case 1:
	{
		...
		do
		{
			...
			case 2:
			{
				...
				case 20:
				{
					Sleep(500);
					Beep(500, 300);
					cout << "Cantidad de Ferrari Integral a comprar: ";
					cout << "Cantidad: "; cin >> c;
					suma40 = (suma40 + 25)*c;
		...
		cout << "*Fecha:                                                                      " << endl;
		//su codigo de la hora estaba aqui xd
		cout << "*                                                                            *" << endl;
		cout << "*Hora:                                                                       " << endl;
		//su codigo de la hora estaba aqui xd
		cout << "*                                                                            *" << endl;
	...
	default:
		Sleep(500);
		Beep(500, 300);
		cout << "    No se ha seleccionado una opcion " << endl;
